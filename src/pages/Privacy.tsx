...
import { ArrowLeft, Database, MessageSquare, BarChart3 } from "lucide-react";
...
export default function Privacy() {
  ...
  const rows = [
    { icon: Database, label: t("dataCollection"), desc: t("dataCollectionDesc"), key: "dataCollection" as const },
    { icon: MessageSquare, label: t("saveChatHistory"), desc: t("saveChatHistoryDesc"), key: "chatHistorySaving" as const },
    { icon: BarChart3, label: t("analytics"), desc: t("analyticsDesc"), key: "analyticsEnabled" as const },
  ];
  ...
  return (
    <PageTransition className="h-screen w-screen max-w-full md:max-w-[600px] mx-auto overflow-y-auto bg-background fixed inset-0">
      <div className="flex items-center gap-3 px-4 safe-header pb-4 glass sticky top-0 z-10">
        ...
        <h1 className="text-lg font-semibold text-foreground">{t("privacy")}</h1>
      </div>
